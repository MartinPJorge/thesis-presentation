...
\begin{frame}
    ...
    Open-source:
    \begin{itemize}
        \item \url{https://github.com/MartinPJorge/placement}
        \item \url{https://github.com/MartinPJorge/5gt-federation}
        \item \url{https://github.com/MartinPJorge/5gt-federation/tree/extensionICC/utils/aws}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{minipage}{0.3\textwidth}
        ...
        \begin{equation}
            \only<1>{d_{\text{net}}(\psi) + d_{\text{net}} \le D(s)}
