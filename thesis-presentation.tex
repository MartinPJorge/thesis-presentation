        ...
        \begin{itemize}
            ...
            \item \textbf{Server} location:
                \begin{itemize}
                    ...
                    \item satisfy tactile latency 1ms
                \end{itemize}
        \end{itemize}
    \end{minipage}
    \begin{minipage}{.5\textwidth}
...
\begin{frame}
    ...
    Open-source:
    \begin{itemize}
        \item \textbf{BS \& server generation}: \url{http://github.com/MartinPJorge/mec-generator/}
...
\begin{frame}
    ...
    \textbf{OKpi} VNE idea: high $\gamma\implies$ more hops
    \begin{figure}
...
\begin{frame}
    ...
    \begin{minipage}{.4\textwidth}
        ...
        \onslide<2->{
            \begin{enumerate}
                \item generate \textbf{5G graphs} meeting standard requirements
                \only<3->{\item maximize revenue under \textbf{federation} and dynamic pricing}
                \only<4->{\item minimize \textbf{VNE} cost meeting: latency, reliability, and availability constraints}
                \only<5->{\item reduce the E2E latency violations with the proposed \textbf{scaling}}
            \end{enumerate}
        }
    \end{minipage}
...
\begin{frame}
    ...
    \begin{minipage}{.45\textwidth}
        Open-source (GitHub):
        \begin{enumerate}
            \item BS \& server generation
            \item 5GEN R package
            \item DFS, BFS w/ cutoffs
            \item Q-table federation 
            \item DQN federation + AWS env.
            \item AMPLPY
            \item network
            \item OKpi
            \item FMC
