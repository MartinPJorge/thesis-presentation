...
\begin{frame}
    ...
    \only<2>{
        \begin{figure}
            \includegraphics[width=.8\textwidth]{img/big-picture-start-edge-fog.pdf}
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \only<1>{\includegraphics[width=.8\textwidth]{img/big-picture-start-edge-fog.pdf}}%
        \only<2>{\includegraphics[width=.8\textwidth]{img/big-picture-infra-gen.pdf}}
        \caption{
            \only<1>{Orchestration of three services in Edge \& Fog.}
...
\begin{frame}
    ...
    \begin{minipage}{.4\textwidth}
        ...
        \onslide<2->{
            \begin{enumerate}
                \item generate \textbf{5G graphs} meeting 1ms RTT
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item \textbf{OKpi} study on $\gamma$/runtime/optimality
