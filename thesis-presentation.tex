...
\begin{frame}
    ...
    To assess NFV orchestration in Edge \& Fog\only<6>{\footnote{The presentation focuses on the main thesis contributions.}}:\pause
    \begin{enumerate}
...
\begin{frame}
    ...
    \onslide<1-2>{\!\!}
    \onslide<3->{BS intensity function $\lambda(x)\sim G(x)$ proportional to gentrification.}
    ...
    \begin{figure}
        ...
        %% \input{grid.tex}
        \caption{Gridded region
            \onslide<2->{(left), and inhomogeneous Mattérn~II process of BSs (right).}}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \only<2>{\includegraphics[width=\textwidth]{img/cdfs-all-decisions_edited_dqn_near_optimal.pdf}}%
        \only<3>{\includegraphics[width=\textwidth]{img/cdfs-all-decisions_edited_dqn_highlighter.pdf}}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \subfigure[][non-COVID-19]{%
            \only<1>{\includegraphics[width=.45\textwidth]{img/draft-non-covid-offline-steps.pdf}}%
            \only<2>{\includegraphics[width=.45\textwidth]{img/draft-non-covid-offline-steps-winner.pdf}}%
            \label{fig:offline-non-covid-steps}%
        }%
        %\hspace{8pt}
        \subfigure[][COVID-19]{%
            \only<1>{\includegraphics[width=.45\textwidth]{img/draft-covid-offline-steps.pdf}}%
            \only<2>{\includegraphics[width=.45\textwidth]{img/draft-covid-offline-steps-winner.pdf}}%
...
\begin{frame}
    ...
    \begin{figure}
        \centering
        \subfigure[][non-COVID-19]{%
            \only<1>{\includegraphics[width=.45\textwidth]{img/draft-non-covid-online-steps.pdf}}%
            \only<2>{\includegraphics[width=.45\textwidth]{img/draft-non-covid-online-steps-winner.pdf}}%
            \label{fig:online-non-covid-steps}%
        }%
        %\hspace{8pt}%
        \subfigure[][COVID-19]{%
            \only<1>{\includegraphics[width=.45\textwidth]{img/draft-covid-online-steps.pdf}}%
            \only<2>{\includegraphics[width=.45\textwidth]{img/draft-covid-online-steps-winner.pdf}}%
